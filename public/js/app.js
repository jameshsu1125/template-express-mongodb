...
function init() {
  ...
  function _onClick() {
    _onClick = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var dataset, api, fetchData, insert, deleteTarget, update, respond, res, data, msg, tbody, html, button;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            fetchData = {};
            _context2.t0 = api;
            _context2.next = _context2.t0 === 'insert' ? 6 : _context2.t0 === 'delete' ? 9 : _context2.t0 === 'update' ? 11 : 13;
            break;
          case 6:
            insert = document.getElementById('insert');
            if (insert) {
              fetchData = _toConsumableArray(insert.getElementsByTagName('input')).reduce(function (prev, next) {
          ...
          case 9:
            ...
            if (deleteTarget) {
              fetchData = {
                _id: _toConsumableArray(deleteTarget.getElementsByTagName('input'))[0].value
              };
            }
          case 11:
            ...
            if (update) {
              fetchData = {
                filter: _toConsumableArray(update.getElementsByTagName('input'))[0].value,
                data: _toConsumableArray(update.getElementsByTagName('input')).filter(function (_, index) {
                  return index !== 0;
          ...
          case 15:
            ...
            _context2.t1 = api;
            _context2.next = _context2.t1 === 'select' ? 21 : _context2.t1 === 'insert' ? 25 : _context2.t1 === 'delete' ? 25 : _context2.t1 === 'update' ? 25 : 27;
            break;
          case 21:
            tbody = document.getElementById('tbody');
            html = data === null || data === void 0 ? void 0 : data.map(function (item, index) {
          ...
          case 25:
            if (res) {
              alert(msg);
              button = document.getElementById('select' + '-btn');
